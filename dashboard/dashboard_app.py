...
6. Keeps Streamlit internal Deploy/settings popovers readable.
"""
...
def clean_table_for_display(df: pd.DataFrame, table_type: str) -> pd.DataFrame:
    """
    Keeps only useful columns and renames them into simple English/Arabic.
    This avoids ugly technical names like response_count and avg_budget_aed.
    """
    if df.empty:
        return df
...
def sidebar_choice(label, options, default, format_func):
    ...
    I intentionally use a dropdown instead of pills because many regions/categories
    can make the sidebar crowded, especially in Arabic mode.
    """
...
# ============================================================
# 16. Business opportunity matrix - product style
# ============================================================
